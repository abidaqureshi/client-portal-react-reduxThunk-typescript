...
const unloadedState: SetsState = {
    ...
    additionalInformation: { ...unloadedSetData },
};
...
export const persistor = (state: SetsState): SetsState => ({
    ...
    backups: { ...state?.backups, isUpdating:false },
    ...
    additionalInformation: { ...state?.additionalInformation, isUpdating: false },
});
