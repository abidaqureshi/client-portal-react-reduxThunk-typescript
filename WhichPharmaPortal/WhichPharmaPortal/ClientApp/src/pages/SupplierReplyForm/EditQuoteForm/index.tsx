...
import OurInfo from '../OurInfoForm/info';
...
const EditQuoteForm: React.FC<QuoteBoxProps> = ({
    ...
    const handleInterest = () => {
        onChange({ ...value, state: RFQQuoteState.InProgress });
    };
            ...
            <CardContent>
                ...
                {value.state !== RFQQuoteState.Declined && (
                    <>
                        <hr />
                        <SupplierInfoForm
                            readOnly={value.state !== RFQQuoteState.Open && value.state !== RFQQuoteState.InProgress}
                            value={value}
                            setValue={setValue}
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} className={classes.centerBox}>
                                ...
                                >
                                    ...
                                    <svg className="MuiSvgIcon-root" viewBox="0 0 24 24" width="30" aria-hidden="true">
